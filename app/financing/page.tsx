...
export default function FinancingPage() {
  ...
  // Helper function to calculate monthly payment using loan formula
  ...
  const getDefaultLoanOptions = (): LoanOptions => {
    const interestRate = 4.99; // Correct APR
    
    const calculateLoanDetails = (years: number) => {
      const monthlyPayment = Math.round(calculateMonthlyPayment(systemCost, interestRate, years));
      const totalPaid = monthlyPayment * years * 12;
      const totalInterest = totalPaid - systemCost;
    ...
    return {
      "3": calculateLoanDetails(3),
      "5": calculateLoanDetails(5),
      "10": calculateLoanDetails(10),
    }
  }
  ...
  useEffect(() => {
    if (!isCustomized) {
      ...
      const interestRate = 4.99 // Use consistent APR
  ...
  const SystemConfiguration = ({ showMonthlyImpact = false }: { showMonthlyImpact?: boolean }) => (
    <div className="space-y-4 md:space-y-6 mb-6"> 
      ...
      {/* Solar Panels - New Design */}
      <div className="w-full lg:max-w-xl mx-auto">
        <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl">
          ...
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-amber-200/20 to-transparent rounded-full translate-y-12 -translate-x-12" />
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden sm:block">
                  <h2 className="text-lg font-bold text-amber-900 leading-tight">Solar Panel System</h2>
                </div>
              </div>
              <Badge variant="secondary" className="bg-amber-200 text-amber-800 font-semibold text-xs px-3 py-1 border-0">
                REQUIRED
              </Badge>
            </div>

            <h2 className="block sm:hidden text-xl font-bold text-amber-900 leading-tight">Solar Panel System</h2>
            <p className="text-amber-800/80 text-sm leading-relaxed">Clean energy foundation for your home</p>
          </CardHeader>
          ...
          <CardContent className="relative pt-0">
            <div className="space-y-4">
              ...
              <div className="flex items-baseline justify-between gap-4">
                <span className="text-3xl font-bold text-amber-900">€{baseSolarCost.toLocaleString()}</span>
                {showMonthlyImpact && (
                  <span className="text-lg font-semibold text-orange-600">
                    €{Math.round((baseSolarCost / systemCost) * selectedLoan.monthlyPayment)}/month
                  </span>
                )}
              </div>
      ...
      {/* Enhanced Addons */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6 mx-auto">
        {addons.map((addon, index) => (
          <div key={addon.name}>
            {addon.enabled ? (
              // New design for enabled state
              <Card className={cn(
                "overflow-hidden border-0 shadow-lg rounded-xl md:rounded-2xl",
                addon.name === "Home Battery"
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      €{addon.cost.toLocaleString()}
                        ...
                        {/* <Badge className="bg-green-200 text-green-800 border-green-300 text-xs hover:bg-green-200 mt-1">
              ...
              // Current design for disabled state
              <div className="group relative overflow-hidden rounded-2xl border-2 border-gray-200 bg-gradient-to-br from-gray-50 to-slate-50 shadow-md opacity-75 p-3 md:p-4 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
                {/* Background Effects */}
                <div className="absolute top-0 right-0 rounded-full blur-2xl opacity-20 transform translate-x-12 md:translate-x-16 -translate-y-12 md:-translate-y-16 transition-all duration-500 w-16 md:w-20 h-16 md:h-20 bg-gray-300"></div>

                <div className="relative z-10 flex items-center">
                  <div className="mr-3 md:mr-4 p-2 md:p-3 bg-gradient-to-br from-gray-400 to-slate-500 rounded-xl md:rounded-2xl transition-all duration-500 shadow-lg flex-shrink-0">
                    <div className="text-white">
                      {addon.icon}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mb-2">
                      <h3 className="text-base md:text-lg lg:text-xl font-bold transition-colors text-gray-600">
                        {addon.name}
                      </h3>
                    </div>
                  </div>

                  <div className="ml-4 md:ml-6 flex flex-col items-center gap-2 md:gap-3 flex-shrink-0 mb-1">
                    <Switch
                      checked={addon.enabled}
                      onCheckedChange={() => toggleAddon(index)}
                      className="transition-all duration-300 scale-110 md:scale-125"
                    />
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-50 via-white to-emerald-50">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="w-full md:max-w-xl mx-auto">
              <div className="bg-gradient-to-b from-emerald-500 to-emerald-600 rounded-3xl p-6 text-white">
                ...
                {/* Disclaimer */}
                <div className="mt-4 pt-4 border-t border-emerald-300/30">
                  <p className="text-xs text-emerald-100/90 text-center leading-relaxed">
                    These figures are for guidance only. Final terms will be provided by your lender after a system quote.
                  </p>
                </div>
              </div>
            </div>
            ...
            <Tabs defaultValue="finance" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg rounded-xl md:rounded-2xl p-1 h-12 md:h-14">
                ...
                >
                  ...
                  <span className="hidden sm:inline mr-1">Smart  </span> Financing
                </TabsTrigger>
                <TabsTrigger
                  value="cash"
                  className="rounded-lg md:rounded-xl text-sm md:text-base font-medium data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-500 data-[state=active]:to-green-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300"
                >
                  ...
                  <span className="hidden sm:inline mr-1">Cash </span> Payment
                </TabsTrigger>
              </TabsList>
                    ...
                    <div className="mb-6 md:mb-8 relative overflow-hidden rounded-xl md:rounded-2xl bg-gradient-to-br from-slate-50 via-white to-emerald-50 p-4 md:p-6 lg:p-8 shadow-xl border border-emerald-100">
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="grid gap-6 md:gap-8 lg:grid-cols-2">
                          ...
                          >
                            {/* Popular badge */}
                            <div className="absolute top-3 right-3 md:top-4 md:right-4 bg-yellow-400 text-yellow-900 px-2 md:px-3 py-1 rounded-full text-[9.5px] md:text-xs font-bold shadow-lg">
                              RECOMMENDED
                            </div>
                        ...
                        >
                          <div className="bg-gradient-to-r from-emerald-100 to-green-100 rounded-xl md:rounded-2xl px-4 md:px-6 py-3 md:py-4 text-center shadow-lg border border-emerald-200">
                            <div className="flex items-center justify-center gap-2 text-emerald-800">
                              ...
                              <span className="font-bold text-sm md:text-base lg:text-lg text-left">Save €{monthlySavings} monthly on energy bills</span>
                            </div>
                        ...
                        <div>
                          ...
                          <div className="mt-4 space-y-3">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-medium text-right">4% of property value</span>
                            </div>
                          </div>
              ...
              <TabsContent value="finance">
                <Card>
                  <CardContent className="pt-6">
                          ...
                          <div className="grid grid-cols-3 gap-2 md:gap-4">
                            {Object.keys(loanOptions).map((term) => (
                              <button
                                ...
                                className={cn(
                                  "relative group rounded-2xl border-2 px-2 py-3 md:p-6 text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1",
                                  selectedTerm === term
                    ...
                    {/* Enhanced Component Payment Breakdown */}
                    <div className="w-full justify-center text-center flex mb-6 ">
                      <div className="w-full  lg:max-w-xl overflow-hidden bg-gradient-to-b from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-gray-200/50 ring-1 ring-gray-300/20"
                      >
                        <div className="p-0">
                          {/* Header */}
                          <div className="p-4 pb-3">
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <h2 className="text-xl font-semibold text-gray-900 text-left">Payment Breakdown</h2>
                            </div>

                            {/* Payment Items */}
                            <div className="space-y-2">
                              {/* Solar Panels */}
                              <div className="flex items-center justify-between py-3 px-2 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl border border-orange-100">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-medium text-[14px] text-gray-700">Solar Panels</span>
                                </div>
                              ...
                              {(() => {
                                ...
                                return (
                                  <div className={cn(
                                    "flex items-center justify-between py-3 px-2 rounded-xl border transition-all",
                                    ...
                                    <span className={cn(
                                      ...
                                      {batteryAddon?.enabled
                                        ? `+ €${Math.round((batteryAddon.cost / systemCost) * selectedLoan.monthlyPayment)}/month`
                                        : "€0/month"
                                      }
                                    </span>
                                  </div>
                                ...
                                return (
                                  <div className={cn(
                                    ...
                                    <span className={cn(
                                      ...
                                      {evAddon?.enabled
                                        ? `+ €${Math.round((evAddon.cost / systemCost) * selectedLoan.monthlyPayment)}/month`
                                        : "€0/month"
                                      }
                                    </span>
                                  </div>
                          ...
                          {/* Total Section */}
                          <div className="p-4 bg-gradient-to-br from-green-500 to-emerald-600 text-white text-left">
                            <div className="block sm:hidden  w-8 h-8 bg-white/20 rounded-lg mb-2 flex items-center justify-center backdrop-blur-sm mr-3">
                    ...
                    {/* Monthly Impact Card - New Design */}
                    <div className="w-full lg:max-w-xl mx-auto mb-6">
                      <div className="bg-white rounded-2xl p-6 shadow-2xl border-2 border-gray-200/50 ring-1 ring-gray-300/20">
                        ...
                        <div className="space-y-4">
                          {/* Monthly payment */}
                          <div className="flex justify-between items-center py-4 px-3 bg-slate-100 rounded-xl">
                            <span className="font-semibold text-slate-700 text-left text-[15px] sm:text-base">Monthly payment</span>
                            <span className="text-lg sm:text-xl font-bold text-slate-900">€{selectedLoan.monthlyPayment}</span>
                          ...
                          {/* Energy savings */}
                          <button
                            onClick={() => setShowSavingsTooltip(true)}
                            className="w-full flex justify-between items-center py-4 px-3 bg-green-100 rounded-xl hover:bg-green-200 transition-all duration-200 group cursor-pointer"
                          >
                            <div className="flex items-center gap-1">
                              <span className="font-semibold text-green-700 text-left text-[15px] sm:text-base">Energy savings</span>
                              <Info className="flex-shrink-0 h-3 w-3 text-green-600 opacity-70 group-hover:opacity-100 transition-opacity" />
                            ...
                            <span className="font-bold text-green-700 text-lg sm:text-xl">- €{monthlySavings}</span>
                          </button>

                          {/* Net monthly cost */}
                          <div className="flex justify-between items-center py-4 px-3 bg-indigo-100 rounded-xl">
                            <span className="font-semibold text-indigo-700 text-left text-[15px] sm:text-base">Net monthly cost</span>
                    ...
                    {/* View Complete Loan Details - Independent Button */}
                    <div className="w-full lg:max-w-xl mx-auto mb-6 mt-8">
                      <button
                        onClick={() => setIsLoanDetailsExpanded(!isLoanDetailsExpanded)}
                        className="w-full flex items-center justify-between p-4 rounded-xl border-2 border-emerald-200 bg-gradient-to-r from-emerald-50 to-green-50 hover:from-emerald-100 hover:to-green-100 transition-all duration-300 group shadow-md hover:shadow-lg"
                      >
                        <span className="font-semibold text-emerald-800 group-hover:text-emerald-900">View Complete Loan Details</span>
                        <ChevronDown
                          className={cn(
                            "h-5 w-5 text-emerald-600 group-hover:text-emerald-700 transition-all duration-300",
                            isLoanDetailsExpanded ? "transform rotate-180" : ""
                          )}
                        />
                      </button>

                      {/* Expandable Loan Details Content */}
                      <div
                        className={cn(
                          "overflow-hidden transition-all duration-500 ease-in-out",
                          isLoanDetailsExpanded ? "opacity-100 mt-6" : "max-h-0 opacity-0"
                        )}
                      >
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 p-6 shadow-lg">
                              <div className="flex items-center gap-2 mb-4">
                                <Calendar className="h-4 w-4 sm:h-6 sm:w-6 text-blue-600 flex-shrink-0" />
                                <h5 className="text-lg font-bold text-blue-900">Loan Benefits & Features</h5>
                              </div>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-3">
                                  <div className="flex-shrink-0 w-4 h-4 sm:w-6 sm:h-6 bg-blue-500 rounded-full flex items-center justify-center mt-0.5 shadow-md">
                    ...
                    <div className="w-full lg:max-w-xl mx-auto my-6">
                      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-300 shadow-lg">
                        ...
                        <div className="relative z-10 p-4 md:p-6">
                          <div className="block sm:hidden flex justify-end mb-2" >
                            {/* <div className="bg-amber-500 text-white px-3 py-1 rounded-full text-center text-[10px] font-bold">
                              INSTANT CASH
                            </div> */}
                          </div>
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <div className="hidden sm:block bg-amber-500 text-white px-3 py-1 rounded-full text-center text-[10px] font-bold">
                                  INSTANT CASH
                                </div>
                              </div>
                          ...
                          {/* <h3 className="block sm:hidden text-lg font-bold text-amber-900 pl-2">Grant Paid at Installation!</h3> 
                          <p className="block sm:hidden text-amber-800 text-sm font-medium pb-2 pl-2" >Get money back before you pay anything</p> */}
                          ...
                          >
                            <span className="text-amber-900 font-medium text-[12px] flex items-center gap-2 text-left">
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mt-2 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
                  ...
                  <p className="text-xl md:text-2xl font-bold text-green-600 text-right">
                    {isNaN(Math.round((systemCost - customDownPayment) / (customTerm * 12))) ? null : (
                      <>
                        €{Math.round((systemCost - customDownPayment) / (customTerm * 12))}
                        <span className="text-sm md:text-base">/mo</span>
                      </>
                    )}
                  </p>
                </div>
      ...
      {/* Energy Savings Calculation Tooltip */}
      {showSavingsTooltip && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto rounded-xl bg-white shadow-xl">
            <div className="sticky top-0 bg-white p-4 md:p-6 border-b border-gray-200 rounded-t-xl">
              <button
              ...
              <div className="text-left pr-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-lg md:text-xl font-bold text-gray-900">How is this calculated?</h2>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                  <p className="text-green-800 leading-relaxed text-sm md:text-base">
                    Based on your selected upgrades, your location, national solar output data, and typical energy
                    usage. We use SEAI and contractor benchmarks to calculate expected monthly savings.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-amber-800 text-sm leading-relaxed">
                        Actual results will vary depending on when and how you use electricity.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-gray-900 text-sm">Monthly Energy Savings Calculation:</h4>
                  
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Annual electricity bill reduction</span>
                        <span className="font-semibold">€{annualSavings.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Divided by 12 months</span>
                        <span className="font-semibold">÷ 12</span>
                      </div>
                      <div className="border-t pt-2 flex justify-between items-center font-bold text-green-600">
                  ...
                  <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                    <div className="text-xs text-blue-800">
                      <strong>Based on:</strong> Your system size, local solar irradiance, typical household consumption patterns, and current electricity rates.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky bottom-0 bg-white p-4 md:p-6 border-t border-gray-200 rounded-b-xl">
              <Button
                onClick={() => setShowSavingsTooltip(false)}
